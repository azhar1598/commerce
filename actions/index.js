...
export const fetchBackendCart = (customerId, groupId, purchaseId, data, addressId) => {
...
export const getBannerImagesAction = (storeId, setData, setLoading, loading) => {
