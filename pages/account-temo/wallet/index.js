...
export const Index = ({ customerDetails, dispatchWalletInfo, dispatchWalletTransactions, stateWalletBalance, storeDetails }) => {
    ...
    return (
        <div className='mt-20 lg:mt-24 md:-mt-4 bg-[#F6F6F6] flex lg:pl-32 md:pl-32 lg:p-8 md:p-8'>
           ...
           {loading?<div className='flex items-center justify-center h-96  '><Spin className=''/></div>:     <>
                <div className='bg-white pl-4 lg:pl-8 lg:p-3 md:pl-8 md:p-3 text-left lg:ml-5 md:ml-5 w-full border-b-4 border-slate-[200]'>
                    <p className='hidden text-black font-montSemiBold  lg:block'>Available Balance</p>
                    ...
                    <p className=' font-montRegular text-[16px] text-green-500 -mt-4 lg:mt-0'>{storeDetails?.currency_symbol} {stateWalletBalance?.customer_wallet_balance}</p>
                </div>
                {/* <div className='bg-white pl-4 lg:pl-8 lg:p-3 md:pl-8 md:p-3 text-left lg:ml-5 md:ml-5 w-full border-b-4 border-slate-[200]'>
                ...
                <p className='hidden lg:block text-[#212B36]  lg:font-montSemiBold font-montRegular lg:pl-8 lg:ml-5 md:ml-5  md:pl-8 bg-white lg:p-4 md:p-4 w-full p-2  '>Wallet Transaction History</p>
