...
export const Index = ({ storeSettings, customerDetails, defaultAddressAction, defaultAddressState, addAddressAction, editAddressAction, checkout, getAddressAction, stateAddress, storeDetails, fetchPurchaseDetails }) => {
    ...
    return (
        ...
        <div className=' lg:mt-24 md:-mt-4 bg-[#F6F6F6] flex lg:pl-32 md:pl-32 lg:p- md:p-8'>
            {/* <Head>
            ...
            <div className='  lg:flex   lg:-mt-8 rounded  bg-[#F6F6F6] md:p-8'>

                <div className='lg:bg-white rounded  lg:mr-20 md:mr-'>
                    <div className='flex flex-col lg: w-full  '>
                        {!showAddressMobile && isTabletOrMobile ?
                            <div className='bg-white pl-4 mt-16 lg:mt-0 lg:pl-8 lg:p-3 md:pl-8 md:p-3 flex text-left lg:ml-5 md:ml-5 w-full border border-blue-100 shadow rounded'>
                        ...
                        {!addNewAddress ?
                            <>
                                {!isTabletOrMobile && 
                                <div className=' lg:w-full lg:-mt-4  pl-4 lg:pl-8 lg:p-3 md:pl-8 md:p-3 flex text-left  w-full rounded '>
                                    ...
                                    <p className='text-black font-montBold mt-8 text-xl' >{!addNewAddress ? 'Saved Places' : 'Add New Address'}</p>
                                </div>}
                                <div className='flex flex-col flex-wrap lg:w-full lg:mr-   lg:pl-8 lg:p-3 md:lg-8 md:p-3  items-center flex-wrap  justify-between w-full  border-b-2 border-slate-[200] cursor-pointer  lg:pb-3 '>
                                    {
                                        stateAddress ?
                                            !showAddressMobile ?
                            ...
                            <>
                                {!isTabletOrMobile &&
                                    <div className='bg-white lg:-mt-4 pl-4 lg:pl-8 lg:p-3 md:pl-8 md:p-3 flex text-left w-full rounded' >
                                ...
                                <div className=" hidden lg:block md:block bg-white w-full lg:pl-8 lg:p-3 md:lg-8 md:p-3 ">
