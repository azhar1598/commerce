...
import { message, Modal, PageHeader, Popconfirm, Radio, Spin } from 'antd'
...
import { addAddressAction, defaultAddress, editAddressAction, getAddressAction } from '../../../actions'
...
export const Index = ({ storeSettings, customerDetails, defaultAddressAction, defaultAddressState, addAddressAction, editAddressAction, getAddressAction, stateAddress, storeDetails }) => {
    ...
    const getData = async () => {
        // const response = await getAddressList(customerDetails?.data?.customer_id)
            ...
            <div className='flex flex-col w-full lg:mr-24 md:mr-24'>
                {!showAddressMobile ?
                    <div className='bg-white pl-4 lg:pl-8 lg:p-3 md:pl-8 md:p-3 flex text-left lg:ml-5 md:ml-5 w-full border-b-4 border-slate-[200] '>
                        ...
                        <p className='text-black font-montSemiBold mt-3 '>Saved Places</p>
                    </div> : ''}
                ...
                {loading ?
                    ...
                    <>
                        {!showAddressMobile ?
                            ...
                            :
                            <div className='lg:hidden md:hidden bg-white p-3 flex items-baseline  w-full border-b-4 border-slate-[200]' onClick={edit ? handleEditMobileAddress : handleDisplayMobileAddress} >
                        ...
                        <div className='flex flex-col lg:flex-row  md:flex-row lg:pl-8 lg:p-3 md:lg-8 md:p-3 items-center flex-wrap  justify-between lg:ml-5 md:ml-5 w-full bg-white border-b-2 border-slate-[200] cursor-pointer '>
                            {!showAddressMobile ?
                                <div className='lg:flex flex-wrap lg:justify-between lg:w-full lg:mb-0 mb-24'>
                                    {stateAddress?.map(item =>
                                        <div className='flex w-full  lg:w-1/2 md:w-1/2 lg:justify-start md:justify-start lg:border-none md:border-none border-b-2 border-slate-200 p-2' key={item.address_id}>
                                            <Radio.Group onChange={() => { handleAddressChange(item) }} buttonStyle={{ color: 'red' }} value={valueAddress} >
                                                <Radio className='font-montSemiBold' options={optionsWithStyle} value={item.address_id}></Radio>
                                            </Radio.Group>
                                            <div className='flex flex-col'>
                                                ...
                                                <div className='flex'>
                                                    ...
                                                    <button className="bg-white  pl-2 pr-2 font-montMedium float-right text-sm" style={{ color: `${storeSettings.data ? storeSettings.data.primary_color : "black"}`, }} onClick={() => editAddress(item)} >Edit</button>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                            ...
                            <div className='p-6'>
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className='space-y-2 my-2'>
                                        ...
                                        <input className={`w-full lg:w-6/12 border border-gray-300 p-2 rounded focus:outline-none focus:ring-1 ${errors.phone ? 'focus:ring-red-600 focus:border-red-600' : 'focus:ring-sky-500 focus:border-sky-500'}`} type="text" placeholder="Enter 10 Digit Mobile Number"
                        ...
                        {showAddressMobile ?
                            <div className="lg:hidden md:hidden bg-white w-full lg:ml-5 md:ml-5 lg:pl-8 lg:p-3 md:lg-8 md:p-3 mb-16">
                                <h2 className='p-6 font-montBold text-xl'>{`${edit ? `Edit Address` : `Add a New Address`}`}</h2>
                                <hr />
                                {/* form */}
                                <div className='p-6'>
