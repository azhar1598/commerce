...
function Filter({ navbarColor, secondaryColor, mobile, grid }) {
    return (
        ...
        <svg width="26" height="15" viewBox="0 0 26 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="7.03125" cy="3.28125" r="2.53125" fill={secondaryColor} stroke={secondaryColor} stroke-width="1.5" />
            <circle cx="20.1562" cy="11.7188" r="2.53125" fill={secondaryColor} stroke={secondaryColor} stroke-width="1.5" />
        </svg>
