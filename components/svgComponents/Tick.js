    ...
    return (
        <div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="33.624" height="33.041" viewBox="0 0 33.624 33.041">
                <g id="Icon_feather-check-circle" dataName="Icon feather-check-circle" transform="translate(-1.497 -1.473)">
                    <path id="Path_4648" dataName="Path 4648" d="M33,16.62V18A15,15,0,1,1,24.105,4.29" fill="none" stroke={secondaryColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
                    <path id="Path_4649" dataName="Path 4649" d="M33,6,18,21.015l-4.5-4.5" fill="none" stroke={secondaryColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
                </g>
            </svg>
