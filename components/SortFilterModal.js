...
export const SortFilterModal = ({ dispatchFilterGroups, storeId, filterAndSortPayload, setFilterAndSortPayload, sortOrder, setSortOrder, handleSortOrder,storeSettings,setLoading }) => {
