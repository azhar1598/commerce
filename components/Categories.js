...
export const Categories = ({
  ...
  const handleSubCategory = (categoryId, subCategoryId, subCategoryName) => {
    ...
    router.push(
      `/shop/?category_id=${categoryId}&sub_category_id=${subCategoryId}&sub_category_name=${subCategoryName}`
    );
  };
  ...
  return (
    <>
      ...
      <div
        className={`hidden  lg:flex items-end justify-between w-full  bg-white ${
          router.pathname == "/shop" ? "-mt-11" : "-mt-[65px]"
        }  fixed z-[1000] px-32 pt-3`}
      >
          ...
          if (key <= 5) {
            return (
              <Category
                ...
                setCloseSubCategory={setCloseSubCategory}
              />
            );
          } else {
            return (
                    ...
                    <div className="flex show-others">
                      <p
                        ...
                        style={
                          ...
                          data?.category_id == categoryKey
                            ? {
                                color: stateStoreSettings
                                  ? stateStoreSettings?.secondary_color
                                  : "black",
                              }
                            : { color: "black" }
                        }
                          ...
                          return (
                            key >= 6 && (
                              <div className="category relative">
                                ...
                                <div className="hidden absolute right-[100%] bg-white  border-blue-100 shadow mt- px-8 py-2  top-0  sub-category">
                                  {/* {closeSubCategory ?
                                                                showOthers &&  */}
                                  {item.subCategories.map((item, key) => {
                                    return (
                                      ...
                                      <p
                                        className="cursor-pointer  min-w-[100%] w-[15vw] "
                                        style={
      ...
      <div className="lg:hidden md:hidden flex">
        ...
        <p
          className="  pl-2 text-lg font-montSemiBold"
      ...
      {showMenu ? (
        <div
          className="lg:hidden md:hidden bg-white fixed h-[100vh] w-full  left-0 top-[4rem] -mt-16"
          style={{ zIndex: 1111 }}
        >
          <div
            ...
            style={{
              color: stateStoreSettings?.data
                ? stateStoreSettings?.data?.navbar_color
                : "white",
              backgroundColor: stateStoreSettings?.data
                ? stateStoreSettings?.data?.primary_color
                : "white",
            }}
          >
            {/* <ArrowLeftOutlined style={{ color: 'black', fontSize: '24px', textAlign: 'left' }} className=' mt-4 pl-4' onClick={openCategorySidebar} /> */}
            <p className="text-lg mt-4 py-3 px-4 font-montSemiBold ">
              Categories
            </p>
          </div>
