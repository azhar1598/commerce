...
export function* handlePolicies(data) {

    try {
        const response = yield handlePoliciesAPI(data)
        yield put(setPolicies(response?.data))
    } catch (error) {
        console.log(error)
    }
